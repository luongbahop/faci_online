<div class="col-md-12 row" >
  ...
  <div class="col-lg-4  right-f">
       ...
       <?php if($detail->parentid==0 && isset($detail)){ ?>
       <div class="form-group">
            <label for="in_home">Hiển thị trang chủ</label>
            <div class="col-md-12">
           		 <p class="col-md-5">
                     <input 
                     	<?php if(isset($detail)){ 
							if($detail->in_home==1) echo "checked";
							} else echo "checked"; 
						?>
                        value="1" 
                        type="radio" 
           		 ...
           		 <p class="col-md-4">
                     <input 
                     	<?php if(isset($detail)){ 
							if($detail->in_home==0) echo "checked";
							}  else echo ""; 
						?>
       ...
       <div class="form-group">
            <label for="in_sidebar">Hiển thị sidebar</label>
            <div class="col-md-12">
           		 <p class="col-md-5">
                     <input 
                     	<?php if(isset($detail)){ 
							if($detail->in_sidebar==1) echo "checked";
							} else echo "checked"; 
						?>
                        value="1" 
                        type="radio" 
                        name="data[in_sidebar]" 
                        id="in_sidebar">
                     <b style="padding-left:5px; white-space:nowrap;">Có</b>
                 </p>
           		 <p class="col-md-4">
                     <input 
                     	<?php if(isset($detail)){ 
							if($detail->in_sidebar==0) echo "checked";
							}  else echo ""; 
						?>
