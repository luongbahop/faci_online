...
$(document).ready(function(e) {
	...
	{
		$('#ajax-category-test').html('<p style="text-align:center"><img src="<?php echo $url_dir; ?>images/loading.gif"></p>');
		$.get('<?php echo $url; ?>ajax-category-test.php',$('#frmCatetest').serialize(),function(data){
			if(!$.trim(data)){
				alert('Dữ liệu trống !');
			}
			else{
				$('#ajax-category-test').html(data);
			}
			;
		});
	}
	...
	<div class="col-lg-12">
    	<form id="frmCatetest">
    	 <div class="form-group input-group col-lg-9" style="float:left;" >
         	<input type="hidden" name="page" value="category-test">
...
<div class="col-md-12">
     <div class="col-md-6" style="margin-bottom:10px;" >
     	<a  class="btn btn-success pull-left" href="<?php echo $url; ?>index.php?page=category-test&action=add&form=1">Thêm mới </a>
     </div>

</div><!-- /.row -->

     <div class="col-lg-12">
        <div class="table-responsive" id="ajax-category-test">
        	<?php include('ajax-category-test.php'); ?>
        </div>
    </div><!-- /.col-md-12 -->
</form>    
</div>
