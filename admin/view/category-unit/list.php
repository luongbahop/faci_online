...
$(document).ready(function(e) {
	...
	{
		$('#ajax-category-unit').html('<p style="text-align:center"><img src="<?php echo $url_dir; ?>images/loading.gif"></p>');
		$.get('<?php echo $url; ?>ajax-category-unit.php',$('#frmCateunit').serialize(),function(data){
			if(!$.trim(data)){
				alert('Dữ liệu trống !');
			}
			else{
				$('#ajax-category-unit').html(data);
			}
			;
		});
	}
	...
	<div class="col-lg-12">
    	<form id="frmCateunit">
    	 <div class="form-group input-group col-lg-9" style="float:left;" >
         	<input type="hidden" name="page" value="category-unit">
...
<div class="col-md-12">
     <div class="col-md-6" style="margin-bottom:10px;" >
     	<a  class="btn btn-success pull-left" href="<?php echo $url; ?>index.php?page=category-unit&action=add&form=1">Thêm mới </a>
     </div>

</div><!-- /.row -->

     <div class="col-lg-12">
        <div class="table-responsive" id="ajax-category-unit">
        	<?php include('ajax-category-unit.php'); ?>
        </div>
    </div><!-- /.col-md-12 -->
</form>    
</div>
