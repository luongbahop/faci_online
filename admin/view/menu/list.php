...
$(document).ready(function(e) {
	...
	function ajax_menu()
	{
		$('#ajax-menu').html('<p style="text-align:center"><img src="<?php echo $url_dir; ?>images/loading.gif"></p>');
		$.get('<?php echo $url; ?>ajax-menu.php',$('#frmMenu').serialize(),function(data){
			if(!$.trim(data)){
				alert('Dữ liệu trống !');
			}
			else{
    	...
    	<form id="frmMenu">
    	 <div class="form-group input-group col-lg-9" style="float:left;" >
            ...
            <select  class="form-control" name="slorder" id="slorder">
                ...
                <option  value="2">--Tên menu từ A->Z--</option>
            	<option  value="3">--Tên menu từ Z->A--</option>
            </select>
            </p>
            <p class="col-md-4" style="float:left">
            <input
...
<div class="col-md-12">
     <div class="col-md-6" style="margin-bottom:10px;" >
     	<a  class="btn btn-success pull-left" href="<?php echo $url; ?>index.php?page=menu&action=add&form=1">Thêm mới </a>
     </div>

</div><!-- /.row -->

     <div class="col-lg-12">
        <div class="table-responsive" id="ajax-menu">
			<?php include('ajax-menu.php'); ?>
        </div>
    </div><!-- /.col-md-12 -->
</form>    
</div>
