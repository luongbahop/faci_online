...
require_once('controller/category-unit.php');
  ...
  <table class="table table-bordered table-hover table-striped">
    ...
    <tbody>
        ...
        <tr <?php if(($key%2==0)) echo "class=''"; else echo "class='primary'";  ?>>
            ...
            <td class="col-md-3">
			<a href="<?php echo $url; ?>index.php?page=test&cat=<?php echo $item['id']; ?>">
			<?php  echo $item['title']; ?>
			</a>
			</td>
            ...
            <td  class="status">
                <a 
                    href="<?php echo $url; ?>index.php?page=category-unit&id=<?php echo $item["id"] ?>&status=<?php echo $item["publish"] ?>&n=<?php echo $n; ?>">
                  <?php 
            ...
            <td class="action-f col-md-1" style="text-align:center;">
            	<a  onClick="return confirm('Bạn có chắc muốn xoá không ?')" href="<?php echo $url; ?>index.php?page=category-unit&action=del&id=<?php echo $item['id'] ?>"> <i class="glyphicon glyphicon-remove"></i> </a> 
                <a href="<?php echo $url; ?>index.php?page=category-unit&action=edit&form=1&id=<?php echo $item['id'] ?>&redirect=<?php echo base64_encode($lib->fullurl());?>">
